...
// Validate ../../src/app/api/admin/inquiries/reply/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/inquiries/reply">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/inquiries/reply/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
